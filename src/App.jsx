      ...
      <main>
        ...
        <section id="section-1">
          <nav>
            ...
            <div className="nav-element">
              <IoIosArrowForward className="icon" /> Our Show Reel
            </div>
            <div className="nav-element">
              <RiMenu3Fill />
            </div>
        ...
        <section id="section-3">
          <div className="top">
            <div className="left">
              <h3>Lorem ipsum dolor <br /> sit amet <br /> consectetur adipisicing <br /> elit. Quo odit!</h3>
            </div>
            <div className="right">
            </div>
          </div>
        ...
        <section id="section-4">
            ...
            <div className="left"></div>
            <div className="right">
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Distinctio aliquid facere a, totam perspiciatis dolor quas aperiam, doloremque reiciendis sequi necessitatibus, culpa saepe pariatur tempore laboriosam soluta optio assumenda debitis nobis aspernatur! Illum aspernatur iste, nam obcaecati asperiores rerum eum quidem ex voluptas expedita sit. Quas nobis rerum ea cupiditate!</p>
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Distinctio aliquid facere a, totam perspiciatis dolor quas aperiam, doloremque reiciendis sequi necessitatibus, culpa saepe pariatur tempore laboriosam soluta optio assumenda debitis nobis aspernatur! Illum aspernatur iste, nam obcaecati asperiores rerum eum quidem ex voluptas expedita sit. Quas nobis rerum ea cupiditate!</p>
            </div>
          </div>
        </section>
